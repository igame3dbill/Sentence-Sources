dunwichhorror={"When a traveller in north central Massachusetts takes the wrong fork at the junction of Aylesbury pike just beyond Dean's Corners he comes upon a lonely and curious country.",
...
" Once across, it is hard to prevent the impression of a faint, malign odour about the village street, as of the massed mould and decay of centuries.",
...
"Outsiders visit Dunwich as seldom as possible, and since a certain season of horror all the signboards pointing towards it have been taken down.",
" The scenery, judged by an ordinary aesthetic canon, is more than commonly beautiful; yet there is no influx of artists or summer tourists.",
...
" The average of their intelligence is woefully low, whilst their annals reek of overt viciousness and of half-hidden murders, incests, and deeds of almost unnameable violence and perversity.",
...
" I myself did not more than a Fortnight ago catch a very plain Discourse of evill Powers in the Hill behind my House; wherein there were a Rattling and Rolling, Groaning, Screeching, and Hissing, such as no Things of this Earth could raise up, and which must needs have come from those Caves that only black Magick can discover, and only the Divell unlock'.",
...
" Oldest of all are the great rings of rough-hewn stone columns on the hilltops, but these are more generally attributed to the Indians than to the settlers.",
...
"m.",
" on Sunday, the second of February, 1913.",
...
"Lavinia was one who would be apt to mutter such things, for she was a lone creature given to wandering amidst thunderstorms in the hills and trying to read the great odorous books which her father had inherited through two centuries of Whateleys, and which were fast falling to pieces with age and wormholes.",
" She had never been to school, but was filled with disjointed scraps of ancient lore that Old Whateley had taught her.",
" The remote farmhouse had always been feared because of Old Whateley's reputation for black magic, and the unexplained death by violence of Mrs Whateley when Lavinia was twelve years old had not helped to make the place popular.",
...
" Neighbours knew nothing of him till a week afterward, when Old Wateley drove his sleigh through the snow into Dunwich Village and discoursed incoherently to the group of loungers at Osborne's general store.",
...
" Ye needn't think the only folks is the folks hereabouts.",
...
" Mamie's visit was frankly one of curiosity, and her subsequent tales did justice to her observations; but Zechariah came to lead a pair of Alderney cows which Old Whateley had bought of his son Curtis.",
" This marked the beginning of a course of cattle-buying on the part of small Wilbur's family which ended only in 1928, when the Dunwich horror came and went; yet at no time did the ramshackle Wateley barn seem overcrowded with livestock.",
" There came a period when people were curious enough to steal up and count the herd that grazed precariously on the steep hillside above the old farm-house, and they could never find more than ten or twelve anaemic, bloodless-looking specimens.",
...
" Odd wounds or sores, having something of the aspect of incisions, seemed to afflict the visible cattle; and once or twice during the earlier months certain callers fancied they could discern similar sores about the throats of the grey, unshaven old man and his slattemly, crinkly-haired albino daughter.",
...
" Silas was rounding up a stray heifer, but he nearly forgot his mission when he fleetingly spied the two figures in the dim light of his lantern.",
...
" Afterwards he could not be sure about the boy, who may have had some kind of a fringed belt and a pair of dark trunks or trousers on.",
...
"There must have been prodigious reserves of strength in the old man to enable him to accomplish so much hard labour; and though he still babbled dementedly at times, his carpentry seemed to show the effects of sound calculation.",
...
" Now, in restoring the abandoned upper storey of the house, he was a no less thorough craftsman.",
" His mania showed itself only in his tight boarding-up of all the windows in the reclaimed section - though many declared that it was a crazy thing to bother with the reclamation at all.",

"Less inexplicable was his fitting up of another downstairs room for his new grandson - a room which several callers saw, though no one was ever admitted to the closely-boarded upper storey.",
...
"'I made some use of 'em,' he would say as he tried to mend a torn black-letter page with paste prepared on the rusty kitchen stove, 'but the boy's fitten to make better use of 'em.",
...
" He had grown as large as a child of four, and was a fluent and incredibly intelligent talker.",
" He ran freely about the fields and hills, and accompanied his mother on all her wanderings.",
...
"The following months were void of visible events, save that everyone swore to a slow but steady increase in the mysterious hill noises.",
" On May Eve of 1915 there were tremors which even the Aylesbury people felt, whilst the following Hallowe'en produced an underground rumbling queerly synchronized with bursts of flame - 'them witch Whateleys' doin's' - from the summit of Sentinel Hill.",
...
" A settled taciturnity was absorbing him, and for the first time people began to speak specifically of the dawning look of evil in his goatish face.",
...
" The aversion displayed towards him by dogs had now become a matter of wide remark, and he was obliged to carry a pistol in order to traverse the countryside in safety.",
" His occasional use of the weapon did not enhance his popularity amongst the owners of canine guardians.",

"The few callers at the house would often find Lavinia alone on the ground floor, while odd cries and footsteps resounded in the boarded-up second storey.",
" She would never tell what her father and the boy were doing up there, though once she turned pale and displayed an abnormal degree of fear when a jocose fish-pedlar tried the locked door leading to the stairway.",
" That pedlar told the store loungers at Dunwich Village that he thought he heard a horse stamping on that floor above.",
" The loungers reflected, thinking of the door and runway, and of the cattle that so swiftly disappeared.",
" Then they shuddered as they recalled tales of Old Whateley's youth, and of the strange things that are called out of the earth when a bullock is sacrificed at the proper time to certain heathen gods.",
...
" It was the publicity attending this investigation which set reporters on the track of the Whateleys, and caused the Boston Globe and Arkham Advertiser to print flamboyant Sunday stories of young Wilbur's precociousness, Old Whateley's black magic, and the shelves of strange books, the sealed second storey of the ancient farmhouse, and the weirdness of the whole region and its hill noises.",
" Wilbur was four and a half then, and looked like a lad of fifteen.",
" His lips and cheeks were fuzzy with a coarse dark down, and his voice had begun to break.",
...
" It was, he said, exactly like a smell he had found in the toolshed abandoned when the house was finally repaired; and like the faint odours which he sometimes thought he caught near the stone circle on the mountains.",
" Dunwich folk read the stories when they appeared, and grinned over the obvious mistakes.",
" They wondered, too, why the writers made so much of the fact that Old Whateley always paid for his cattle in gold pieces of extremely ancient date.",
...
" Twice a year they would light fires on the top of Sentinel Hill, at which times the mountain rumblings would recur with greater and greater violence; while at all seasons there were strange and portentous doings at the lonely farm-house.",
" In the course of time callers professed to hear sounds in the sealed upper storey even when all the family were downstairs, and they wondered how swiftly or how lingeringly a cow or bullock was usually sacrificed.",
...
"About 1923, when Wilbur was a boy of ten whose mind, voice, stature, and bearded face gave all the impressions of maturity, a second great siege of carpentry went on at the old house.",
" It was all inside the sealed upper part, and from bits of discarded lumber people concluded that the youth and his grandfather had knocked out all the partitions and even removed the attic floor, leaving only one vast open void between the ground storey and the peaked roof.",
" They had torn down the great central chimney, too, and fitted the rusty range with a flimsy outside tin stove-pipe.",
...
" They know it's a-goin' aout, an' dun't calc'late to miss it.",
" Yew'll know, boys, arter I'm gone, whether they git me er not.",
" Ef they dew, they'll keep up a-singin' an' laffin' till break o' day.",
" Ef they dun't they'll kinder quiet daown like.",
" I expeck them an' the souls they hunts fer hev some pretty tough tussles sometimes.",
...
" He found Old Whateley in a very grave state, with a cardiac action and stertorous breathing that told of an end not far off.",
" The shapeless albino daughter and oddly bearded grandson stood by the bedside, whilst from the vacant abyss overhead there came a disquieting suggestion of rhythmical surging or lapping, as of the waves on some level beach.",
...
" Yew grows - an' that grows faster.",
" It'll be ready to serve ye soon, boy.",
" Open up the gates to Yog-Sothoth with the long chant that ye'll find on page 751 of the complete edition, an' then put a match to the prison.",
...
"'Feed it reg'lar, Willy, an' mind the quantity; but dun't let it grow too fast fer the place, fer ef it busts quarters or gits aout afore ye opens to Yog-Sothoth, it's all over an' no use.",
" Only them from beyont kin make it multiply an' work.",
...
" It was the same for more than an hour, when the final throaty rattle came.",
" Dr Houghton drew shrunken lids over the glazing grey eyes as the tumult of birds faded imperceptibly to silence.",
" Lavinia sobbed, but Wilbur only chuckled whilst the hill noises rumbled faintly.",
...
" In 1925, when a scholarly correspondent from Miskatonic University called upon him one day and departed pale and puzzled, he was fully six and three-quarters feet tall.",
...
"'They's more abaout him as I knows than I kin tell ye, Mamie,' she said, 'an' naowadays they's more nor what I know myself.",
" I vaow afur Gawd, I dun't know what he wants nor what he's a-tryin' to dew.",
"That Hallowe'en the hill noises sounded louder than ever, and fire burned on Sentinel Hill as usual; but people paid more attention to the rhythmical screaming of vast flocks of unnaturally belated whippoorwills which seemed to be assembled near the unlighted Whateley farmhouse.",
...
" Then they vanished, hurrying southward where they were fully a month overdue.",
...
"In the summer of 1927 Wilbur repaired two sheds in the farmyard and began moving his books and effects out to them.",
" Soon afterwards Earl Sawyer told the loungers at Osborn's that more carpentry was going on in the Whateley farmhouse.",
...
" People generally suspected him of knowing something about his mother disappearance, and very few ever approached his neighbourhood now.",
...
" He had never seen a city before, but had no thought save to find his way to the university grounds; where indeed, he passed heedlessly by the great white-fanged watchdog that barked with unnatural fury and enmity, and tugged frantically at its stout chaim.",
...
" This much he could not civilly refrain from telling the librarian - the same erudite Henry Armitage (A.",
"M.",
" Miskatonic, Ph.",
"D.",
" Princeton, Litt.",
"D.",
" Johns Hopkins) who had once called at the farm, and who now politely plied him with questions.",
" He was looking, he had to admit, for a kind of formula or incantation containing the frightful name Yog-Sothoth, and it puzzled him to find discrepancies, duplications, and ambiguities which made the matter of determination far from easy.",
...
" They's things in it I've got to try under sarten conditions that I can't git here, en' it 'ud be a mortal sin to let a red-tape rule hold me up.",
" Let me take it along, Sir, an' I'll swar they wun't nobody know the difference.",
" I dun't need to tell ye I'll take good keer of it.",
...
" Armitage, half-ready to tell him he might make a copy of what parts he needed, thought suddenly of the possible consequences and checked himself.",
" There was too much responsibility in giving such a being the key to such blasphemous outer spheres.",
" Whateley saw how things stood, and tried to answer lightly.",

"'Wal, all right, ef ye feel that way abaout it.",
" Maybe Harvard won't be so fussy as yew be.",
"' And without saying more he rose and strode out of the building, stooping at each doorway.",
...
" Unseen things not of earth - or at least not of tridimensional earth - rushed foetid and horrible through New England's glens, and brooded obscenely on the mountain tops.",
" Of this he had long felt certain.",
" Now he seemed to sense the close presence of some terrible part of the intruding horror, and to glimpse a hellish advance in the black dominion of the ancient and once passive nightmare.",
...
" 'As a foulness shall ye know them,' he quoted.",
...
" He got in communication with Dr Houghton of Aylesbury, who had attended Old Whateley in his last illness, and found much to ponder over in the grandfather's last words as quoted by the physician.",
" A visit to Dunwich Village failed to bring out much that was new; but a close survey of the Necronomicon, in those parts which Wilbur had sought so avidly, seemed to supply new and terrible clues to the nature, methods, and desires of the strange evil so vaguely threatening this planet.",
...
"The Dunwich horror itself came between Lammas and the equinox in 1928, and Dr Armitage was among those who witnessed its monstrous prologue.",
" He had heard, meanwhile, of Whateley's grotesque trip to Cambridge, and of his frantic efforts to borrow or copy from the Necronomicon at the Widener Library.",
...
"Early in August the half-expected outcome developed, and in the small hours of the third Dr Armitage was awakened suddenly by the wild, fierce cries of the savage watchdog on the college campus.",
" Deep and terrible, the snarling, half-mad growls and barks continued; always in mounting volume, but with hideously significant pauses.",
" Then there rang out a scream from a wholly different throat - such a scream as roused half the sleepers of Arkham and haunted their dreams ever afterwards - such a scream as could come from no being born of earth, or wholly of earth.",
...
" An open window showed black and gaping in the moonlight.",
" What had come had indeed completed its entrance; for the barking and the screaming, now fast fading into a mixed low growling and moaning, proceeded unmistakably from within.",
...
" Professor Rice declares that he wholly lost consciousness for an instant, though he did not stumble or fall.",
...
" The thing itself, however, crowded out all other images at the time.",
...
" It was partly human, beyond a doubt, with very manlike hands and head, and the goatish, chinless face had the stamp of the Whateley's upon it.",
...
"Above the waist it was semi-anthropomorphic; though its chest, where the dog's rending paws still rested watchfully, had the leathery, reticulated hide of a crocodile or alligator.",
...
" When the thing breathed, its tail and tentacles rhythmically changed colour, as if from some circulatory cause normal to the non-human greenish tinge, whilst in the tail it was manifest as a yellowish appearance which alternated with a sickly grayish-white in the spaces between the purple rings.",
...
" At first the syllables defied all correlation with any speech of earth, but towards the last there came some disjointed fragments evidently taken from the Necronomicon, that monstrous blasphemy in quest of which the thing had perished.",
" These fragments, as Armitage recalls them, ran something like 'N'gai, n'gha'ghaa, bugg-shoggog, y'hah: Yog-Sothoth, Yog-Sothoth .",
"' They trailed off into nothingness as the whippoorwills shrieked in rhythmical crescendos of unholy anticipation.",
...
" One need not describe the kind and rate of shrinkage and disintegration that occurred before the eyes of Dr Armitage and Professor Rice; but it is permissible to say that, aside from the external appearance of face and hands, the really human element in Wilbur Whateley must have been very small.",
...
" Apparently Whateley had had no skull or bony skeleton; at least, in any true or stable sense.",
" He had taken somewhat after his unknown father.",
...
" They found the countryside in great agitation, both because of the growing rumblings beneath the domed hills, and because of the unwonted stench and the surging, lapping sounds which came increasingly from the great empty shell formed by Whateley's boarded-up farmhouse.",
" Earl Sawyer, who tended the horse and cattle during Wilbur's absence, had developed a woefully acute case of nerves.",
" The officials devised excuses not to enter the noisome boarded place; and were glad to confine their survey of the deceased's living quarters, the newly mended sheds, to a single visit.",
" They filed a ponderous report at the courthouse in Aylesbury, and litigations concerning heirship are said to be still in progress amongst the innumerable Whateleys, decayed and undecayed, of the upper Miskatonic valley.",
...
" No trace of the ancient gold with which Wilbur and Old Whateley had always paid their debts has yet been discovered.",

"It was in the dark of September ninth that the horror broke loose.",
" The hill noises had been very pronounced during the evening, and dogs barked frantically all night.",
" Early risers on the tenth noticed a peculiar stench in the air.",
" About seven o'clock Luther Brown, the hired boy at George Corey's, between Cold Spring Glen and the village, rushed frenziedly back from his morning trip to Ten-Acre Meadow with the cows.",
...
"'Up thar in the rud beyont the glen, Mis' Corey - they's suthin' ben thar! It smells like thunder, an' all the bushes an' little trees is pushed back from the rud like they'd a haouse ben moved along of it.",
" An' that ain't the wust, nuther.",
" They's prints in the rud, Mis' Corey - great raound prints as big as barrel-heads, all sunk dawon deep like a elephant had ben along, only they's a sight more nor four feet could make! I looked at one or two afore I run, an' I see every one was covered with lines spreadin' aout from one place, like as if big palm-leaf fans - twict or three times as big as any they is - hed of ben paounded dawon into the rud.",
" An' the smell was awful, like what it is around Wizard Whateley's ol' haouse.",
"Here he faltered, and seemed to shiver afresh with the fright that had sent him flying home.",
" Mrs Corey, unable to extract more information, began telephoning the neighbours; thus starting on its rounds the overture of panic that heralded the major terrors.",
" When she got Sally Sawyer, housekeeper at Seth Bishop's, the nearest place to Whateley's, it became her turn to listen instead of transmit; for Sally's boy Chauncey, who slept poorly, had been up on the hill towards Whateley's, and had dashed back in terror after one look at the place, and at the pasturage where Mr Bishop's cows had been left out all night.",

"'Yes, Mis' Corey,' came Sally's tremulous voice over the party wire, 'Cha'ncey he just come back a-postin', and couldn't half talk fer bein' scairt! He says Ol' Whateley's house is all bowed up, with timbers scattered raound like they'd ben dynamite inside; only the bottom floor ain't through, but is all covered with a kind o' tar-like stuff that smells awful an' drips daown offen the aidges onto the graoun' whar the side timbers is blowed away.",
" An' they's awful kinder marks in the yard, tew - great raound marks bigger raound than a hogshead, an' all sticky with stuff like is on the browed-up haouse.",
" Cha'ncey he says they leads off into the medders, whar a great swath wider'n a barn is matted daown, an' all the stun walls tumbled every whichway wherever it goes.",

"'An' he says, says he, Mis' Corey, as haow he sot to look fer Seth's caows, frightened ez he was an' faound 'em in the upper pasture nigh the Devil's Hop Yard in an awful shape.",
...
" Seth hes gone aout naow to look at 'em, though I'll vaow he won't keer ter git very nigh Wizard Whateley's! Cha'ncey didn't look keerful ter see whar the big matted-daown swath led arter it leff the pasturage, but he says he thinks it p'inted towards the glen rud to the village.",
...
" He wa'n't all human hisself, I allus says to everybody; an' I think he an' Ol' Whateley must a raised suthin' in that there nailed-up haouse as ain't even so human as he was.",
" They's allus ben unseen things araound Dunwich - livin' things - as ain't human an' ain't good fer human folks.",

"'The graoun' was a-talkin' las' night, an' towards mornin' Cha'ncey he heered the whippoorwills so laoud in Col' Spring Glen he couldn't sleep nun.",
" Then he thought he heered another faint-like saound over towards Wizard Whateley's - a kinder rippin' or tearin' o' wood, like some big box er crate was bein' opened fur off.",
" What with this an' that, he didn't git to sleep at all till sunup, an' no sooner was he up this mornin', but he's got to go over to Whateley's an' see what's the matter.",
...
" I know suthin' awful's abaout, an' feel my time is nigh, though only Gawd knows jest what it is.",

"'Did your Luther take accaount o' whar them big tracks led tew? No? Wal, Mis' Corey, ef they was on the glen rud this side o' the glen, an' ain't got to your haouse yet, I calc'late they must go into the glen itself.",
" They would do that.",
" I allus says Col' Spring Glen ain't no healthy nor decent place.",
" The whippoorwills an' fireflies there never did act like they was creaters o' Gawd, an' they's them as says ye kin hear strange things a-rushin' an' a-talkin' in the air dawon thar ef ye stand in the right place, atween the rock falls an' Bear's Den.",
"By that noon fully three-quarters of the men and boys of Dunwich were trooping over the roads and meadows between the newmade Whateley ruins and Cold Spring Glen, examining in horror the vast, monstrous prints, the maimed Bishop cattle, the strange, noisome wreck of the farmhouse, and the bruised, matted vegetation of the fields and roadside.",
" Whatever had burst loose upon the world had assuredly gone down into the great sinister ravine; for all the trees on the banks were bent and broken, and a great avenue had been gouged in the precipice-hanging underbrush.",
...
" About two in the morning a frightful stench and the savage barking of the dogs awakened the household at Elmer Frye's, on the eastern edge of Cold Spring Glen, and all agreed that they could hear a sort of muffled swishing or lapping sound from somewhere outside.",
...
" It came, apparently, from the barn; and was quickly followed by a hideous screaming and stamping amongst the cattle.",
...
" The Fryes, huddled together in the sitting-room, did not dare to move until the last echoes died away far down in Cold Spring Glen.",
...
" Two titan swaths of destruction stretched from the glen to the Frye farmyard, monstrous prints covered the bare patches of ground, and one side of the old red barn had completely caved in.",
" Of the cattle, only a quarter could be found and identified.",
...
" Old Zebulon Whateley, of a branch that hovered about halfway between soundness and decadence, made darkly wild suggestions about rites that ought to be practiced on the hill-tops.",
...
" In a few cases closely related families would band together and watch in the gloom under one roof; but in general there was only a repetition of the barricading of the night before, and a futile, ineffective gesture of loading muskets and setting pitchforks handily about.",
...
" There were even bold souls who proposed an offensive expedition down in the glen, though they did not venture to set an actual example to the still reluctant majority.",

"When night came again the barricading was repeated, though there was less huddling together of families.",
" In the morning both the Frye and the Seth Bishop households reported excitement among the dogs and vague sounds and stenches from afar, while early explorers noted with horror a fresh set of the monstrous tracks in the road skirting Sentinel Hill.",
" As before, the sides of the road showed a bruising indicative of the blasphemously stupendous bulk of the horror; whilst the conformation of the tracks seemed to argue a passage in two directions, as if the moving mountain had come from Cold Spring Glen and returned to it along the same path.",
" At the base of the hill a thirty-foot swath of crushed shrubbery saplings led steeply upwards, and the seekers gasped when they saw that even the most perpendicular places did not deflect the inexorable trail.",
" Whatever the horror was, it could scale a sheer stony cliff of almost complete verticality; and as the investigators climbed round to the hill's summit by safer routes they saw that the trail ended - or rather, reversed - there.",
...
" Men looked at one another and muttered.",
" Then they looked down the hill.",
" Apparently the horror had descended by a route much the same as that of its ascent.",
" To speculate was futile.",
" Reason, logic, and normal ideas of motivation stood confounded.",
...
"M.",
" all the party telephones rang tremulously.",
" Those who took down their receivers heard a fright-mad voice shriek out, 'Help, oh, my Gawd! .",
"' and some thought a crashing sound followed the breaking off of the exclamation.",
" There was nothing more.",
" No one dared do anything, and no one knew till morning whence the call came.",
" Then those who had heard it called everyone on the line, and found that only the Fryes did not reply.",
" The truth appeared an hour later, when a hastily assembled group of armed men trudged out to the Frye place at the head of the glen.",
" It was horrible, yet hardly a surprise.",
...
" Only a stench and a tarry stickiness.",
" The Elmer Fryes had been erased from Dunwich.",

"VIII.",

"In the meantime a quieter yet even more spiritually poignant phase of the horror had been blackly unwinding itself behind the closed door of a shelf-lined room in Arkham.",
...
" It was his belief that, considering the great amount of text involved, the writer would scarcely have wished the trouble of using another speech than his own, save perhaps in certain special formulae and incantations.",
...
" Several times he seemed near daylight, only to be set back by some unforeseen obstacle.",
" Then, as September approached, the clouds began to clear.",
" Certain letters, as used in certain parts of the manuscript, emerged definitely and unmistakably; and it became obvious that the text was indeed in English.",
...
" It was in truth a diary, as all had thought; and it was couched in a style clearly showing the mixed occult erudition and general illiteracy of the strange being who wrote it.",
" Almost the first long passage that Armitage deciphered, an entry dated November 26, 1916, proved highly startling and disquieting.",
" It was written,he remembered, by a child of three and a half who looked like a lad of twelve or thirteen.",
...
" I guess he won't.",
" Grandfather kept me saying the Dho formula last night, and I think I saw the inner city at the 2 magnetic poles.",
" I shall go to those poles when the earth is cleared off, if I can't break through with the Dho-Hna formula when I commit it.",
...
" That upstairs looks it will have the right cast.",
...
" He had not left the manuscript all night, but sat at his table under the electric light turning page after page with shaking hands as fast as he could decipher the cryptic text.",
" He had nervously telephoned his wife he would not be home, and when she brought him a breakfast from the house he could scarcely dispose of a mouthful.",
" All that day he read on, now and then halted maddeningly as a reapplication of the complex key became necessary.",
" Lunch and dinner were brought him, but he ate only the smallest fraction of either.",
" Toward the middle of the next night he drowsed off in his chair, but soon woke out of a tangle of nightmares almost as hideous as the truths and menaces to man's existence that he had uncovered.",

"On the morning of September fourth Professor Rice and Dr Morgan insisted on seeing him for a while, and departed trembling and ashen-grey.",
...
" In the small hours of that night he slept a little in a easy chair in his office, but was at the manuscript again before dawn.",
...
"'Stop them, stop theml' he would shout.",
" 'Those Whateleys meant to let them in, and the worst of all is left! Tell Rice and Morgan we must do something - it's a blind business, but I know how to make the powder.",
" It hasn't been fed since the second of August, when Wilbur came here to his death, and at that rate.",
"But Armitage had a sound physique despite his seventy-three years, and slept off his disorder that night without developing any real fever.",
" He woke late Friday, clear of head, though sober with a gnawing fear and tremendous sense of responsibility.",
" Saturday afternoon he felt able to go over to the library and summon Rice and Morgan for a conference, and the rest of that day and evening the three men tortured their brains in the wildest speculation and the most desperate debate.",
...
" All three had seen the body of Wilbur Whateley as it lay on the floor in a room of that very building, and after that not one of them could feel even slightly inclined to treat the diary as a madman's raving.",
...
"Monday was a repetition of Sunday with Dr Armitage, for the task in hand required an infinity of research and experiment.",
" Further consultations of the monstrous diary brought about various changes of plan, and he knew that even in the end a large amount of uncertainty must remain.",
" By Tuesday he had a definite line of action mapped out, and believed he would try a trip to Dunwich within a week.",
" Then, on Wednesday, the great shock came.",
" Tucked obscurely away in a corner of the Arkham Advertiser was a facetious little item from the Associated Press, telling what a record-breaking monster the bootleg whisky of Dunwich had raised up.",
" Armitage, half stunned, could only telephone for Rice and Morgan.",
" Far into the night they discussed, and the next day was a whirlwind of preparation on the part of them all.",
...
"Friday morning Armitage, Rice, and Morgan set out by motor for Dunwich, arriving at the village about one in the afternoon.",
...
" From the air of hushed fright at Osborn's store they knew something hideous had happened, and soon learned of the annihilation of the Elmer Frye house and family.",
...
" The trail up and down Sentinel Hill seemed to Armitage of almost cataclysmic significance, and he looked long at the sinister altar-like stone on the summit.",

"At length the visitors, apprised of a party of State Police which had come from Aylesbury that morning in response to the first telephone reports of the Frye tragedy, decided to seek out the officers and compare notes as far as practicable.",
" This, however, they found more easily planned than performed; since no sign of the party could be found in any direction.",
...
" Then old Sam Hutchins thought of something and turned pale, nudging Fred Farr and pointing to the dank, deep hollow that yawned close by.",
...
"A cold shudder ran through natives and visitors alike, and every ear seemed strained in a kind of instinctive, unconscious listening.",
" Armitage, now that he had actually come upon the horror and its monstrous work, trembled with the responsibility he felt to be his.",
...
" He saw that his electric flashlight was in working order.",
" Rice, beside him, took from a valise a metal sprayer of the sort used in combating insects; whilst Morgan uncased the big-game rifle on which he relied despite his colleague's warnings that no material weapon would be of help.",
...
" He hoped that it might be conquered without any revelation to the world of the monstrous thing it had escaped.",
" As the shadows gathered, the natives commenced to disperse homeward, anxious to bar themselves indoors despite the present evidence that all human locks and bolts were useless before a force that could bend trees and crush houses when it chose.",
" They shook their heads at the visitors' plan to stand guard at the Frye ruins near the glen; and, as they left, had little expectancy of ever seeing the watchers again.",
...
" But the looked-for terror did not appear.",
" Whatever was down there in the glen was biding its time, and Armitage told his colleagues it would be suicidal to try to attack it in the dark.",

"Morning came wanly, and the night-sounds ceased.",
" It was a grey, bleak day, with now and then a drizzle of rain; and heavier and heavier clouds seemed to be piling themselves up beyond the hills to the north-west.",
" The men from Arkham were undecided what to do.",
" Seeking shelter from the increasing rainfall beneath one of the few undestroyed Frye outbuildings, they debated the wisdom of waiting, or of taking the aggressive and going down into the glen in quest of their nameless, monstrous quarry.",
" The downpour waxed in heaviness, and distant peals of thunder sounded from far horizons.",
" Sheet lightning shimmered, and then a forky bolt flashed near at hand, as if descending into the accursed glen itself.",
" The sky grew very dark, and the watchers hoped that the storm would prove a short, sharp one followed by clear weather.",

"It was still gruesomely dark when, not much over an hour later, a confused babel of voices sounded down the road.",
" Another moment brought to view a frightened group of more than a dozen men, running, shouting, and even whimpering hysterically.",
...
" 'It's a-goin' agin, an' this time by day! It's aout - it's aout an' a-movin' this very minute, an' only the Lord knows when it'll be on us all!'",
"The speaker panted into silence, but another took up his message.",

"'Nigh on a haour ago Zeb Whateley here heered the 'phone a-ringin', an' it was Mis' Corey, George's wife, that lives daown by the junction.",
...
" An' she says he says they was a swishin' lappin' saound, more nor what the bendin' trees an' bushes could make, an' all on a suddent the trees along the rud begun ter git pushed one side, an' they was a awful stompin' an' splashin' in the mud.",
" But mind ye, Luther he didn't see nothin' at all, only just the bendin' trees an' underbrush.",

"'Then fur ahead where Bishop's Brook goes under the rud he heerd a awful creakin' an' strainin' on the bridge, an' says he could tell the saound o' wood a-startin' to crack an' split.",
" An' all the whiles he never see a thing, only them trees an' bushes a-bendin'.",
" An' when the swishin' saound got very fur off - on the rud towards Wizard Whateley's an' Sentinel Hill - Luther he had the guts ter step up whar he'd heerd it fust an' look at the graound.",
" It was all mud an' water, an' the sky was dark, an' the rain was wipin' aout all tracks abaout as fast as could be; but beginnin' at the glen maouth, whar the trees hed moved, they was still some o' them awful prints big as bar'ls like he seen Monday.",
"At this point the first excited speaker interrupted.",

"'But that ain't the trouble naow - that was only the start.",
" Zeb here was callin' folks up an' everybody was a-listenin' in when a call from Seth Bishop's cut in.",
" His haousekeeper Sally was carryin' on fit to kill - she'd jest seed the trees a-bendin' beside the rud, an' says they was a kind o' mushy saound, like a elephant puffin' an' treadin', a-headin' fer the haouse.",
...
" An' the dogs was barkin' an' whinin' awful.",

"'An' then she let aout a turrible yell, an' says the shed daown the rud had jest caved in like the storm bed blowed it over, only the wind w'an't strong enough to dew that.",
" Everybody was a-listenin', an' we could hear lots o' folks on the wire a-gaspin'.",
" All to onct Sally she yelled again, an' says the front yard picket fence hed just crumbled up, though they wa'n't no sign o' what done it.",
" Then everybody on the line could hear Cha'ncey an' old Seth Bishop a-yellin' tew, an' Sally was shriekin' aout that suthin' heavy hed struck the haouse - not lightnin' nor nothin', but suthin' heavy again' the front, that kep' a-launchin' itself agin an' agin, though ye couldn't see nothin' aout the front winders.",
" An' then.",
" an' then.",
"Lines of fright deepened on every face; and Armitage, shaken as he was, had barely poise enough to prompt the speaker.",

"'An' then.",
" Sally she yelled aout, 'O help, the haouse is a-cavin' in.",
" an' on the wire we could hear a turrible crashin' an' a hull flock o' screaming.",
...
" Jest still-like.",
" We that heerd it got aout Fords an' wagons an' rounded up as many able-bodied men-folks as we could git, at Corey's place, an' come up here ter see what yew thought best ter dew.",
" Not but what I think it's the Lord's jedgment fer our iniquities, that no mortal kin ever set aside.",
...
"' He made his voice as reassuring as possible.",
" 'I believe there's a chance of putting it out of business.",
" You men know that those Whateleys were wizards - well, this thing is a thing of wizardry, and must be put down by the same means.",
" I've seen Wilbur Whateley's diary and read some of the strange old books he used to read; and I think I know the right kind of spell to recite to make the thing fade away.",
" Of course, one can't be sure, but we can always take a chance.",
" It's invisible - I knew it would be - but there's powder in this long-distance sprayer that might make it show up for a second.",
" Later on we'll try it.",
" It's a frightful thing to have alive, but it isn't as bad as what Wilbur would have let in if he'd lived longer.",
" You'll never know what the world escaped.",
" Now we've only this one thing to fight, and it can't multiply.",
" It can, though, do a lot of harm; so we mustn't hesitate to rid the community of it.",

"'We must follow it - and the way to begin is to go to the place that has just been wrecked.",
" Let somebody lead the way - I don't know your roads very well, but I've an idea there might be a shorter cut across lots.",
" How about it?'",
...
"'I guess ye kin git to Seth Bishop's quickest by cuttin' across the lower medder here, wadin' the brook at the low place, an' climbin' through Carrier's mowin' an' the timber-lot beyont.",
" That comes aout on the upper rud mighty nigh Seth's - a leetle t'other side.",
"Armitage, with Rice and Morgan, started to walk in the direction indicated; and most of the natives followed slowly.",
" The sky was growing lighter, and there were signs that the storm had worn itself away.",
" When Armitage inadvertently took a wrong direction, Joe Osborn warned him and walked ahead to show the right one.",
" Courage and confidence were mounting, though the twilight of the almost perpendicular wooded hill which lay towards the end of their short cut, and among whose fantastic ancient trees they had to scramble as if up a ladder, put these qualities to a severe test.",

"At length they emerged on a muddy road to find the sun coming out.",
" They were a little beyond the Seth Bishop place, but bent trees and hideously unmistakable tracks showed what had passed by.",
" Only a few moments were consumed in surveying the ruins just round the bend.",
" It was the Frye incident all over again, and nothing dead or living was found in either of the collapsed shells which had been the Bishop house and barn.",
...
"As the men passed the site of Wilbur Whateley's abode they shuddered visibly, and seemed again to mix hesitancy with their zeal.",
...
" Opposite the base of Sentinel Hill the tracks left the road, and there was a fresh bending and matting visible along the broad swath marking the monster's former route to and from the summit.",

"Armitage produced a pocket telescope of considerable power and scanned the steep green side of the hill.",
" Then he handed the instrument to Morgan, whose sight was keener.",
...
" Sawyer, as clumsy as most non-users of optical devices are, fumbled a while; but eventually focused the lenses with Armitage's aid.",
...
" Spells might be all right - but suppose they weren't? Voices began questioning Armitage about what he knew of the thing, and no reply seemed quite to satisfy.",
...
" After much patient instruction regarding its focusing and use, they left the telescope with the frightened group that remained in the road; and as they climbed they were watched closely by those among whom the glass was passed round.",
" It was hard going, and Armitage had to be helped more than once.",
" High above the toiling group the great swath trembled as its hellish maker repassed with snail-like deliberateness.",
" Then it was obvious that the pursuers were gaining.",

"Curtis Whateley - of the undecayed branch - was holding the telescope when the Arkham party detoured radically from the swath.",
...
" This, indeed, proved to be true; and the party were seen to gain the minor elevation only a short time after the invisible blasphemy had passed it.",

"Then Wesley Corey, who had taken the glass, cried out that Armitage was adjusting the sprayer which Rice held, and that something must be about to happen.",
" The crowd stirred uneasily, recalling that his sprayer was expected to give the unseen horror a moment of visibility.",
...
"Those without the telescope saw only an instant's flash of grey cloud - a cloud about the size of a moderately large building - near the top of the mountain.",
" Curtis, who held the instrument, dropped it with a piercing shriek into the ankle-deep mud of the road.",
...
" Curtis was past all coherence, and even isolated replies were almost too much for him.",

"'Bigger'n a barn.",
" all made o' squirmin' ropes.",
" hull thing sort o' shaped like a hen's egg bigger'n anything with dozens o' legs like hogs-heads that haff shut up when they step.",
" nothin' solid abaout it - all like jelly, an' made o' sep'rit wrigglin' ropes pushed clost together.",
" great bulgin' eyes all over it.",
" ten or twenty maouths or trunks a-stickin' aout all along the sides, big as stove-pipes an all a-tossin' an openin' an' shuttin'.",
...
" Fred Farr and Will Hutchins carried him to the roadside and laid him on the damp grass.",
" Henry Wheeler, trembling, turned the rescued telescope on the mountain to see what he might.",
" Through the lenses were discernible three tiny figures, apparently running towards the summit as fast as the steep incline allowed.",
" Only these - nothing more.",
" Then everyone noticed a strangely unseasonable noise in the deep valley behind, and even in the underbrush of Sentinel Hill itself.",
...
"Earl Sawyer now took the telescope and reported the three figures as standing on the topmost ridge, virtually level with the altar-stone but at a considerable distance from it.",
...
" The weird silhouette on that remote peak must have been a spectacle of infinite grotesqueness and impressiveness, but no observer was in a mood for aesthetic appreciation.",
" 'I guess he's sayin' the spell,' whispered Wheeler as he snatched back the telescope.",
" The whippoorwills were piping wildly, and in a singularly curious irregular rhythm quite unlike that of the visible ritual.",

"Suddenly the sunshine seemed to lessen without the intervention of any discernible cloud.",
" It was a very peculiar phenomenon, and was plainly marked by all.",
...
" The chanting of the men from Arkham now became unmistakable, and Wheeler saw through the glass that they were all raising their arms in the rhythmic incantation.",
" From some farmhouse far away came the frantic barking of dogs.",

"The change in the quality of the daylight increased, and the crowd gazed about the horizon in wonder.",
" A purplish darkness, born of nothing more than a spectral deepening of the sky's blue, pressed down upon the rumbling hills.",
" Then the lightning flashed again, somewhat brighter than before, and the crowd fancied that it had showed a certain mistiness around the altar-stone on the distant height.",
" No one, however, had been using the telescope at that instant.",
...
"Without warning came those deep, cracked, raucous vocal sounds which will never leave the memory of the stricken group who heard them.",
" Not from any human throat were they born, for the organs of man can yield no such acoustic perversions.",
" Rather would one have said they came from the pit itself, had not their source been so unmistakably the altar-stone on the peak.",
...
" They were loud - loud as the rumblings and the thunder above which they echoed - yet did they come from no visible being.",
" And because imagination might suggest a conjectural source in the world of non-visible beings, the huddled crowd at the mountain's base huddled still closer, and winced as if in expectation of a blow.",

"'Ygnailh.",
" ygnaiih.",
" thflthkh'ngha.",
" Yog-Sothoth .",
"' rang the hideous croaking out of space.",
" 'Y'bthnk.",
" h'ehye - n'grkdl'lh.",
"The speaking impulse seemed to falter here, as if some frightful psychic struggle were going on.",
" Henry Wheeler strained his eye at the telescope, but saw only the three grotesquely silhouetted human figures on the peak, all moving their arms furiously in strange gestures as their incantation drew near its culmination.",
...
" h'yuh.",
" HELP! HELP! .",
"ff - ff - ff - FATHER! FATHER! YOG-SOTHOTH!.",
"But that was all.",
...
" Trees, grass, and under-brush were whipped into a fury; and the frightened crowd at the mountain's base, weakened by the lethal foetor that seemed about to asphyxiate them, were almost hurled off their feet.",
...
" To this day there is something queer and unholy about the growths on and around that fearsome hill Curtis Whateley was only just regaining consciousness when the Arkham men came slowly down the mountain in the beams of a sunlight once more brilliant and untainted.",
" They were grave and quiet, and seemed shaken by memories and reflections even more terrible than those which had reduced the group of natives to a state of cowed quivering.",
" In reply to a jumble of questions they only shook their heads and reaffirmed one vital fact.",

"'The thing has gone for ever,' Armitage said.",
" 'It has been split up into what it was originally made of, and can never exist again.",
" It was an impossibility in a normal world.",
" Only the least fraction was really matter in any sense we know.",
" It was like its father - and most of it has gone back to him in some vague realm or dimension outside our material universe; some vague abyss out of which only the most accursed rites of human blasphemy could ever have called him for a moment on the hills.",
"There was a brief silence, and in that pause the scattered senses of poor Curtis Whateley began to knit back into a sort of continuity; so that he put his hands to his head with a moan.",
" Memory seemed to pick itself up where it had left off, and the horror of the sight that had prostrated him burst in upon him again.",
...
"'But as to this thing we've just sent back - the Whateleys raised it for a terrible part in the doings that were to come.",
...
" You needn't ask how Wilbur called it out of the air.",
